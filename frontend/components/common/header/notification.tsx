...
const Notification = ({ setNotification }: IProps) => {
  return (
    <>
      <div className="w-96 absolute z-10 right-0 h-96 mt-3 border-2 overflow-y-auto transform translate-x-0 transition ease-in-out duration-700">
        <div className=" bg-gray-50 h-screen  w-full p-8  right-0">

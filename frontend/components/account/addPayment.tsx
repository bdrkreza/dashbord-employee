...
import { expenses_api } from "../../pages/api/expenses";
import { IInVoices } from "../../Types";
import Expenses from "./expenses";
import ClientInvoice from "./invoice";
import InvoiceTableAccount from "./invoiceTable";
import TabsButtonAccount from "./tabsButton";

type Props = {
  data: IInVoices[] | null;
};

export default function AddPayment({ data }: Props) {
    ...
    <div>
      <div className="mt-10">
        <div className="flex items-center justify-between px-14">
          ...
          <TabsButtonAccount setOpenTab={setOpenTab} openTab={openTab} />
        </div>

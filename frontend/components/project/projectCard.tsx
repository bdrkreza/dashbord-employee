  ...
  return (
    <>
      <div className="w-full grid  sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-3 gap-1">
        {project?.map(
          ({ projectName, image, color, stage }: IProject, index: any) => {
            return (
              <div
                key={index}
              ...
              >
                <div className="bg-white border-x-2  dark:bg-gray-800 rounded shadow  max-w-xl py-6 sm:px-8 px-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div>
                      <img src={image} className="max-w-xl h-16" alt="image" />
                    </div>
                  </div>
                  ...
                  <div className="mt-8 flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-center">
                      <div
                        className={`bg-${color}-100 text-${color}-700 border-1 -ml-2 rounded-xl px-4 py-2 max-w-fit`}
                      >
                        <h2>{stage}</h2>
                      </div>
